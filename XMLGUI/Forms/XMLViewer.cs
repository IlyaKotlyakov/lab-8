...
namespace XMLGUI
{
    public partial class XMLViewer : Form
    {
        ...
        //перерисовывание дерева чиателей и их книг
        ...
        private void DeleteToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Удалять можно только Читателя или Книгу", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            workTree.SelectedNode.Remove();
        }

        //сохранение дерефа в файл
        ...
        {
            if (workTree.SelectedNode == null || !(workTree.SelectedNode.Tag is Reader))
            {
